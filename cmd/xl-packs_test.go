...
// TestStorageInfoPacks - tests storage info for erasure coded packs of disks.
func TestStorageInfoPacks(t *testing.T) {
	var objs []*xlObjects
...
func TestHashedLayer(t *testing.T) {
	...
	for i, testCase := range testCases {
		gotObj := packs.getHashedLayer(testCase.objectName)
