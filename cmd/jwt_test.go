...
func testAuthenticate(authType string, t *testing.T) {
	...
	testCases := []struct {
		...
		// Secret key too long.
		{"myuser", "pass1234567890123456789012345678901234567pass1234567890123456789012345678901234567pass1234567890123456789012345678901234567", errInvalidSecretKeyLength},
